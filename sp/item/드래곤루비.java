...
public class 드래곤루비 extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp){
		...
		if(cha.getLevel() < 15) {
			ChattingController.toChatting(cha, "이 아이템은 15레벨 이상이 되어야 사용할 수 있습니다.", 20);
			return;
		}
...
//		
		...
		if(cha instanceof PcInstance){
			...
			if(s != null) {
				// 스킬 적용.
				드래곤루비버프.onBuff(cha, s, s.getBuffDuration(), false);
