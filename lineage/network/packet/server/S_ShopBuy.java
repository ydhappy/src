...
public class S_ShopBuy extends S_Inventory {
	...
	static public BasePacket clone(BasePacket bp, object shop, Object... opt) {
		if (bp == null)
			bp = new S_ShopBuy(shop, opt);
		else
			((S_ShopBuy) bp).toClone(shop, opt);
		return bp;
	}

	public S_ShopBuy(object shop, Object... opt) {
		toClone(shop, opt);
	}
