...
public class S_ObjectLock extends ServerBasePacket {
	...
	public void clone(int type) {
		...
		/*
		 * 0 마비풀림[움직이지못함] 2 마비걸림[움직이지못함] 커스패럴라이즈용 4 마비걸림[움직이지못함] 어스바인드용 이런식으로 나눠서 보내서
		 * 중복되도록 가능 5 마비풀림[움직이지못함] 10 잠들어버림 포그 11 잠풀림 12 얼어버렸습니다 13 얼어버린거 풀림 22 쇼크스턴
		 * 마비걸림 [쇼크스턴아이콘포함] 스턴 23 쇼크스턴 마비풀림 24 발이묶임 [거미줄모양아이콘포함] 인탱글 25 발이풀림
		 */
	}
}
