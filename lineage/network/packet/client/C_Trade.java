...
public class C_Trade extends ClientBasePacket {
	...
	static synchronized public BasePacket clone(BasePacket bp, byte[] data, int length){
		if(bp == null)
			bp = new C_Trade(data, length);
		else
			((C_Trade)bp).clone(data, length);
		return bp;
	}
	
	public C_Trade(byte[] data, int length){
		clone(data, length);
	}
...
//				if (o.isPersnalShopInsert()||o.isPersnalShopPriceSetting()||o.isPersnalShopEdit()
//					||	o.isPersnalShopAddPriceSetting()||o.isPersnalShopSellInsert() ||
//					o.isPersnalShopPriceReset() || o.isPersnalShopSellPriceSetting() ||
//					o.isPersnalShopSellEdit() || o.isPersnalShopSellPriceReSetting()||
//					o.isPersnalShopPurchasePriceIn()){
//					pc.toChatting(pc, "현재 상대방은 개인상점 진행중입니다");
//					return null;
//				}
		...
		// \f1거래할 사람이 없습니다.
		pc.toSender(S_Message.clone(BasePacketPooling.getPool(S_Message.class), 260));
		return null;
	}
