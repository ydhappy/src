...
public class C_ObjectParty extends ClientBasePacket {
	...
	public BasePacket init(PcInstance pc){
		...
		int type = isRead(5) ? readC() : 0;
		object o = isRead(4) ? pc.findInsideList(readD()) : getPlayer(pc);
		if(o!=null && (pc.getGm()>0 || !pc.isTransparent()) && o instanceof PcInstance) {
			//
			if(o instanceof RobotInstance)
				return this;
			PartyController.toParty(pc, (PcInstance)o, false, false);
		}
