...
public class MaanBirth extends Magic {
	...
	public void toBuffEnd(object o) {
		...
		if (o instanceof Character) {
			...
			ChattingController.toChatting(cha, "탄생의 마안 종료", Lineage.CHATTING_MODE_MESSAGE);
		}
	}
	...
	public void toBuff(object o) {
		if (getTime() == Lineage.buff_magic_time_max || getTime() == Lineage.buff_magic_time_min)
			ChattingController.toChatting(o, "탄생의 마안: " + getTime() + "초 후 종료", Lineage.CHATTING_MODE_MESSAGE);
	}

	static public void init(object o, int time) {
		BuffController.append(o, MaanBirth.clone(BuffController.getPool(MaanBirth.class), SkillDatabase.find(715), time));
	}
	...
	static public void init(Character cha, Skill skill) {
		...
		ChattingController.toChatting(cha, "탄생의 마안: 일정 확률로 물리 회피 상승, 마법 대미지 50% 감소, 지령 내성+5, 수령 내성+5", Lineage.CHATTING_MODE_MESSAGE);
	}
}
