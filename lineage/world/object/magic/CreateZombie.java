...
public class CreateZombie {
	...
	static public void init(Character cha, Skill skill, int object_id) {
		...
		if (o != null) {
			...
			if (SkillController.isMagic(cha, skill, true) && o instanceof MonsterInstance
				...
				if (mi.isDead() && SummonController.isAppend(null, cha, SummonController.TYPE.TAME)) {
					// 이팩트 처리.
					cha.toSender(S_ObjectEffect.clone(BasePacketPooling.getPool(S_ObjectEffect.class), mi,
							skill.getCastGfx()));
					// 테이밍 처리.
