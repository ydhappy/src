...
public class FrameSpeedOverStun extends Magic {
	...
	public void toBuffEnd(object o) {
		...
		// 여기가 하나로 하면 록이 안풀렸으니
		// 굳은거 풀어버리고
		o.toSender(S_ObjectLock.clone(BasePacketPooling.getPool(S_ObjectLock.class), 0x03));
//		o.toSender(S_ObjectLock.clone(BasePacketPooling.getPool(S_ObjectLock.class), 0x5));
//		o.toSender(S_ObjectLock.clone(BasePacketPooling.getPool(S_ObjectLock.class), 0x9));
//		o.toSender(S_ObjectLock.clone(BasePacketPooling.getPool(S_ObjectLock.class), 0xB));
//		o.toSender(S_ObjectLock.clone(BasePacketPooling.getPool(S_ObjectLock.class), 0xD));
		//이렇게 해도 되용네 테스트 해볼게요
		o.toSender(S_ObjectPoisonLock.clone(BasePacketPooling.getPool(S_ObjectPoisonLock.class), o), true);
