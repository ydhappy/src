...
public class CurseGhoul extends Magic {
	...
	static public void init(Character cha, int time){
		...
		BuffController.append(cha, CurseGhoul.clone(BuffController.getPool(CurseGhoul.class), SkillDatabase.find(100, 0), time));
	}
	...
	static public void init(MonsterInstance mi, object o, MonsterSkill ms, int action, int effect, boolean check){
		...
		if(SkillController.isFigure(mi, o, ms.getSkill(), true, false) && !o.isLock()){
			...
			BuffController.append(o, CurseGhoul.clone(BuffController.getPool(CurseGhoul.class), ms.getSkill(), ms.getBuffDuration()));
		}
	}
