...
public class ChattingClose extends Magic {
	...
	static public void init(Character cha, int time){
		...
		BuffController.append(cha, ChattingClose.clone(BuffController.getPool(ChattingClose.class), SkillDatabase.find(100, 1), time*60));
	}
	...
	static public void init(Character cha, int time, boolean message){
		...
		BuffController.append(cha, ChattingClose.clone(BuffController.getPool(ChattingClose.class), SkillDatabase.find(100, 1), time));
	}
