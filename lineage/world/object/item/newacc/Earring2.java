...
public class Earring2 extends ItemArmorInstance {
...
// 인첸을 성공했다면
	...
	public void toEquipped(Character cha, Inventory inv, int slot){
		...
		if(equipped){
			switch(getEnLevel()){
			case 1: cha.setEarring2(1.05);
				break;
			case 2: cha.setEarring2(1.09);
				break;
			case 3: cha.setEarring2(1.1);
				break;
			case 4: cha.setEarring2(1.2);
				break;
			case 5: cha.setEarring2(1.3);
				break;
			case 6: cha.setEarring2(1.4);
				break;
			case 7: cha.setEarring2(1.5);
				break;
			case 8: cha.setEarring2(1.6);
				break;
		}
		}else{
			cha.setEarring(1);
