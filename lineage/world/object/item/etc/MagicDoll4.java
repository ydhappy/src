...
public class MagicDoll4 extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp){
		...
		for(ItemInstance ii : cha.getInventory().getList()){
			...
			if((ii.getName().equalsIgnoreCase("$20692")) || (ii.getName().equalsIgnoreCase("$20693")) || (ii.getName().equalsIgnoreCase("$20696")) ||
				(ii.getName().equalsIgnoreCase("$20695")) || (ii.getName().equalsIgnoreCase("$20698")) ){
				cnt = cnt+1;
		...
		if(cnt>2){
			for(ItemInstance iii : cha.getInventory().getList()){
				if(iii.getName().equalsIgnoreCase("$20692") ){
					cha.getInventory().remove(iii, true);
					knt = knt +1;
				}else if(iii.getName().equalsIgnoreCase("$20693") ){
					cha.getInventory().remove(iii, true);
					knt = knt +1;
				}else if(iii.getName().equalsIgnoreCase("$20696") ){
					cha.getInventory().remove(iii, true);
					knt = knt +1;
				}else if(iii.getName().equalsIgnoreCase("$20695") ){
					cha.getInventory().remove(iii, true);
					knt = knt +1;
				}else if(iii.getName().equalsIgnoreCase("$20698") ){
					cha.getInventory().remove(iii, true);
					knt = knt +1;
				}
				if(knt == 3){
					...
					ChattingController.toChatting(cha, String.format("4차 마법 인형 바구니를 습득 하셨습니다.", 20));
					return;
				}
			}
			...
			ChattingController.toChatting(cha, String.format("3차인형 3개가 부족합니다.", 20));
			return;
		}
	}
}
