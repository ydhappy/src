...
public class ResetStatusScroll2 extends ItemInstance
{
  ...
  public static synchronized ItemInstance clone(ItemInstance paramItemInstance)
  {
    ...
    if (paramItemInstance == null)
      paramItemInstance = new ResetStatusScroll2();
    return paramItemInstance;
  }

  public void toClick(Character paramCharacter, ClientBasePacket paramClientBasePacket)
  {
	  if(paramCharacter.getClassType()  != 1) {
			ChattingController.toChatting(paramCharacter, "\\fX기사클래스만 사용 가능합니다", 20);
			  return ;
		  }
  ...
  private StatDice StatDice(Character paramCharacter)
  {
    ...
    case 3:
      ...
      case 1:
        ...
        localStatDice.setCon(14);
        localStatDice.setWis(14);
        localStatDice.setCha(18);
        localStatDice.setInt(14);
        break;
      case 2:
        localStatDice.setStr(8);
        localStatDice.setDex(7);
...
//	      j = Lineage.blackwizard_mp;
//	    }
//	    StatDice localStatDice = StatDice(cha);
//	    int k = localStatDice.getStr();
//	    int m = localStatDice.getDex();
//	    int n = localStatDice.getCon();
//	    int i1 = localStatDice.getWis();
...
//	    str.append(new StringBuilder().append("Str: ").append(k).toString());
//	    str.append(new StringBuilder().append(" Dex: ").append(m).toString());
//	    str.append(new StringBuilder().append(" Con: ").append(n).toString());
//	    str.append(new StringBuilder().append(" Wis: ").append(i1).toString());
//	    str.append(new StringBuilder().append(" Cha: ").append(i2).toString());
//	    str.append(new StringBuilder().append(" Int: ").append(i3).toString());
//	    int i4 = 0;
//	    int i5 = 0;
//	    int i6 = 1;
...
//	    str.append(new StringBuilder().append(" Hp: ").append(i7).toString());
//	    str.append(new StringBuilder().append(" Mp: ").append(i8).toString());
//	    str.append(new StringBuilder().append(" lv: ").append(i6).toString());
//	    ChattingController.toChatting(cha, str.toString(), 20);
