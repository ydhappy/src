...
public class ScrollLabeledDaneFools2Cal extends Enchant {

	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new ScrollLabeledDaneFools2Cal();
		return item;
	}
	//칼바스의 두루마리
	@Override
	...
	protected boolean isEnchant(Character cha, ItemInstance weapon) {
		...
		if(bress == 2) {
			...
			if(weapon.getItem().getSafeEnchant()==0){
				...
				case 0: enchant_chance = 53;break;
				case 1: enchant_chance = 35;break;
				case 2: enchant_chance = 24;break;
				...
				switch(weapon.getEnLevel()){
				case 6: enchant_chance = 53;break;
				case 7: enchant_chance = 35;break;
				case 8: enchant_chance = 24;break;
