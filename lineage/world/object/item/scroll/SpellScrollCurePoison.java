...
public final class SpellScrollCurePoison extends ItemInstance {
	
	private Skill skill;
	
	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new SpellScrollCurePoison();
		item.setSkill( SkillDatabase.find(2, 0) );
		return item;
	}
