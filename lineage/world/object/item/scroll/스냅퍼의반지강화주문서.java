...
public class 스냅퍼의반지강화주문서 extends ScrollLabeledDaneFools {

	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new 스냅퍼의반지강화주문서();
		return item;
	}
	...
	protected boolean isEnchant(Character cha, ItemInstance item) {
		...
		if (bress == 2) {
			...
			case 0: enchant_chance = 50;
			break;
		case 1: enchant_chance = 40;
			break;
		case 2: enchant_chance = 30;
			break;
		case 3: enchant_chance = 20;
			break;
		case 4: enchant_chance = 10;
			break;
		case 5: enchant_chance = 0;
			break;
		case 6: enchant_chance = 25;
			break;
