...
public final class SpellScrollHolyWeapon extends ItemInstance {
	
	private Skill skill;
	
	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new SpellScrollHolyWeapon();
		item.setSkill( SkillDatabase.find(1, 7) );
		return item;
	}
