...
public class ScrollLabeledZelgoMer2Ga extends Enchant {

	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new ScrollLabeledZelgoMer2Ga();
		return item;
	}
//기안의 두루마리
	@Override
...
protected boolean isEnchant(Character cha, ItemInstance armor) {
	...
	if(bress == 2) {
		...
		if(armor.getItem().getSafeEnchant()==0){
			...
			case 0: enchant_chance = 35;break;
			case 1: enchant_chance = 15;break;
			case 2: enchant_chance = 14;break;
			case 3: enchant_chance = 12;break;
			case 4: enchant_chance = 5;break;
			case 5: enchant_chance = 4;break;
			case 6: enchant_chance = 3;break;
			default:
				for(int i=armor.getItem().getSafeEnchant() ; i<armor.getEnLevel() ; ++i)
					enchant_chance = enchant_chance * 0.16;
				break;
			...
			switch(armor.getEnLevel()){
			case 4: enchant_chance = 35;break;
			case 5: enchant_chance = 15;break;
			case 6: enchant_chance = 14;break;
			case 7: enchant_chance = 12;break;
			case 8: enchant_chance = 5;break;
			case 9: enchant_chance = 4;break;
			case 10: enchant_chance = 3;break;
			default:
				for(int i=armor.getItem().getSafeEnchant() ; i<armor.getEnLevel() ; ++i)
					enchant_chance = enchant_chance * 0.16;
				break;
