...
public final class SpellScrollDetection extends ItemInstance {
	
	private Skill skill;
	
	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new SpellScrollDetection();
		item.setSkill( SkillDatabase.find(2, 4) );
		return item;
	}
