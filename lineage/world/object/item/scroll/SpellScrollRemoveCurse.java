...
public final class SpellScrollRemoveCurse extends ItemInstance {
	
	private Skill skill;
	
	static synchronized public ItemInstance clone(ItemInstance item){
		if(item == null)
			item = new SpellScrollRemoveCurse();
		item.setSkill( SkillDatabase.find(5, 4) );
		return item;
	}
