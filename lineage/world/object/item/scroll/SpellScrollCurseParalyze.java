...
public final class SpellScrollCurseParalyze extends ItemInstance {

	private Skill skill;

	static synchronized public ItemInstance clone(ItemInstance item) {
		if (item == null)
			item = new SpellScrollCurseParalyze();
		item.setSkill(SkillDatabase.find(5, 0));
		return item;
	}
