...
public class ItemShing extends ItemInstance {
	...
	static synchronized public ItemInstance clone(ItemInstance item) {
		if (item == null)
			item = new ItemShing();
		item.setSkill(SkillDatabase.find(83));
		return item;
	}
	...
	public void toClick(Character cha, ClientBasePacket cbp) {
		...
		if (cha.getClassType() == 0x00 && cha.getLevel() >= 30) {
			...
			ChattingController.toChatting(cha, "30레벨 이상 군주케릭이 사용 가능합니다.");
			return;
		}
	}
}