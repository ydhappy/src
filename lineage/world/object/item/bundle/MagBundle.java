...
public class MagBundle extends ItemInstance {
			...
			if(isClassCheck(cha)) {
				...
				for(ItemBundle ib : list){
						...
						if(ii.getItem().getType1().equalsIgnoreCase("weapon")){
							ii.setAdd_Min_Dmg(Util.random(3, 5));
							ii.setAdd_Max_Dmg(Util.random(3, 5));
							ii.setAdd_Str(Util.random(0, 2));
							ii.setAdd_Dex(Util.random(0, 2));
							ii.setAdd_Con(Util.random(0, 2));
							ii.setAdd_Int(Util.random(0, 2));
							ii.setAdd_Wiz(Util.random(0, 2));
							ii.setAdd_Cha(Util.random(0, 2));
							ii.setAdd_Hp(Util.random(20, 50));
							ii.setAdd_Mana(Util.random(20, 50));
						}else if(ii.getItem().getType1().equalsIgnoreCase("armor")){
							ii.setAdd_Str(Util.random(0, 1));
							ii.setAdd_Dex(Util.random(0, 1));
							ii.setAdd_Con(Util.random(0, 1));
							ii.setAdd_Int(Util.random(0, 1));
							ii.setAdd_Wiz(Util.random(0, 1));
							ii.setAdd_Cha(Util.random(0, 1));
							ii.setAdd_Hp(Util.random(10, 30));
							ii.setAdd_Mana(Util.random(10, 30));
						}
