...
public class DogCollar extends ItemInstance {
	...
	public void close(){
		super.close();
		petName = null;
		petObjectId = petClassId = petLevel = petHp = petGfx = 0;
	...
	public int getPetGfx() {
		return petGfx;
	}

	public void setPetGfx(int petGfx) {
		this.petGfx = petGfx;
	}
	...
	public void toWorldJoin(Connection con, PcInstance pc){
		...
		// 펫이 삭제된 상태라면 목걸이 제거.
		if(petDel){
			pc.getInventory().count(this, pc.getCount() - 1, Lineage.server_version<=200);
