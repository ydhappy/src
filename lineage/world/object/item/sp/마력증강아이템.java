...
public class 마력증강아이템 extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp){
		if(BuffController.find(cha).find(마력증강마법.class) != null) {
			ChattingController.toChatting(cha, "이미 마력 증강 효과를 받고 있어, 사용할 수 없습니다.", 20);
			return;
		}
