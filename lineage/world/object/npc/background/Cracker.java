...
import lineage.database.ScarecrowDropItemDatabase;
		...
		if (cha instanceof PcInstance) {
			...
			if ((weapon != null) && (type == Lineage.ATTACK_TYPE_WEAPON || type == Lineage.ATTACK_TYPE_BOW)) {
				...
				if (pc.getLevel() < Lineage.cracker_exp_max_level)
					pc.toExp(this, Util.random(2, 6));
				// 일정 확률로 템 주기.
				ScarecrowDropItemDatabase.getInstance().Drop(pc); 
