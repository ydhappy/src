...
public class Bahof extends DwarfInstance {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		...
		if(k==null || k.getUid()!=kingdom.getUid()){
			...
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "bahofop", null, list_html));
		}else{
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "bahof"));
		}
	}
}
