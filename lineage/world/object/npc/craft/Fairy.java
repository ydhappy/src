...
public class Fairy extends ElvenGuard {

	static synchronized public object clone(object o, Npc n){
		if(o == null)
			o = NpcSpawnlistDatabase.newObject(n, new Fairy(n));
		else
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		...
		if(pc.getClassType()==0x02 || pc.getGm()>0){
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "fairye1"));
		}else{
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "fairym1"));
		}
	}
