...
public class Lsmith extends CraftInstance {

	public Lsmith(Npc npc) {
		super(npc);
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp, Object... opt) {
		if(
				action.equalsIgnoreCase("request craft") || 
				action.equalsIgnoreCase("1") || 
				action.equalsIgnoreCase("2") || 
				action.equalsIgnoreCase("3") || 
				action.equalsIgnoreCase("4") || 
				action.equalsIgnoreCase("5") || 
				action.equalsIgnoreCase("6") || 
				action.equalsIgnoreCase("7") || 
				action.equalsIgnoreCase("8")
				) {
			switch(pc.getKarmaLevel()) {
				...
				case 7:
					...
					break;
				case 8:
					pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "lsmithi"));
					break;
				default:
