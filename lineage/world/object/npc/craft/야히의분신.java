...
public class 야히의분신 extends CraftInstance {

	public 야히의분신(Npc npc) {
		super(npc);
		...
		if (i != null) {
			...
			l.add(new Craft(ItemDatabase.find("영혼의 구"), 1));
			list.put(i, l);
		}
		...
		i = ItemDatabase.find("얼음 여왕의 지팡이");
		if (i != null) {
			craft_list.put("request enchanted staff of ice queen", i);
			List<Craft> l = new ArrayList<Craft>();
