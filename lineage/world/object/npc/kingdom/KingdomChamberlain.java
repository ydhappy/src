...
public class KingdomChamberlain extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		...
		if(pc.getGm()!=0 || pc.getClassType()==0x00)
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp, Object...opt){
		if(pc.getGm() == 0){
			if(kingdom==null || kingdom.getClanId()==0 || kingdom.getClanId()!=pc.getClanId() || pc.getClassType()!=0x00 || kingdom.isWar())
				return;
		}
	...
	public void toTaxSetting(PcInstance pc, int tax_rate){
		if(pc.getGm()==0 && (kingdom==null || kingdom.getClanId()==0 || kingdom.getClanId()!=pc.getClanId() || pc.getClassType()!=0x00 || tax_rate<0 || tax_rate<Lineage.min_tax || tax_rate>Lineage.max_tax)) {
			ChattingController.toChatting(pc, "세금설정에 실패 하였습니다.", 20);
			return;
		}
	...
	public void toTaxPut(PcInstance pc, long count){
		if(kingdom==null || kingdom.getClanId()==0 || pc.getClanId()!=kingdom.getClanId() || pc.getClassType()!=0x00 || count<=0)
			return;
	...
	public void toTaxGet(PcInstance pc, long count){
		if(kingdom==null || kingdom.getClanId()==0 || pc.getClanId()!=kingdom.getClanId() || pc.getClassType()!=0x00 || count<=0 || kingdom.getTaxTotal()<count)
			return;
