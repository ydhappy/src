...
public class Cspace extends TeleportInstance {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		if(getMap() == 601) {
//			Quest q = QuestController.find(pc, Lineage.QUEST_CSPACE);
//			if(q == null)
//				q = QuestController.newQuest(pc, this, Lineage.QUEST_CSPACE);
			...
			if(action.equalsIgnoreCase("a")) {
				switch(getGfx()) {
					...
					case 5459:	// 파도의 방 604
						...
						break;
					case 5460:	// 발록의 아지트
						if(pc.getInventory().find(ItemDatabase.find("원소의 지배자")) != null)
							pc.toPotal(32670, 32832, 603);
						else
							pc.toSender(S_Message.clone(BasePacketPooling.getPool(S_Message.class), 337, "원소의 지배자"));
						break;
				}
			}
		} else {
