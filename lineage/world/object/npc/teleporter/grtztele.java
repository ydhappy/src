...
public class grtztele extends TeleportInstance {
	
	public grtztele(Npc npc){
		super(npc);
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp, Object...opt){
		if(action.equalsIgnoreCase("teleportURL")){
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "grtztele1", null, list.get(0)));
		}else{
