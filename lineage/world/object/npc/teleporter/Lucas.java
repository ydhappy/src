...
public class Lucas extends TeleportInstance {
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp, Object...opt){
		if(action.equalsIgnoreCase("teleportURL")){
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "teleisland2", null, list.get(0)));
		}else if(action.equalsIgnoreCase("teleportURLA")){
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "teleisland2", null, list.get(1)));
		}else{
