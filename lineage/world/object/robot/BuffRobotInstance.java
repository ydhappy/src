...
public class BuffRobotInstance extends RobotInstance {
	...
	// 같이 버프시전할 객체들
	protected List<BuffRobotInstance> list;
	...
	//		o.setGfx( i<3 ? (Util.random(0, 1)==0 ? 1186 : 734) : (Util.random(0, 1)==0 ? 37 : 138) );
			o.setName(String.format("%s%d", "헤이보조", i));
	...
	//		o.setGfx( i<3 ? (Util.random(0, 1)==0 ? 1186 : 734) : (Util.random(0, 1)==0 ? 37 : 138) );
			o.setLawful(-32767);
			o.setName(String.format("%s%d", "버프보조", i));
			//o.setName(String.format(name));
			o.setTitle("2000원");
			list.add(o);
		}
		...
		list_ment.add(String.format("[기란헤이샵] %d원 서비스 팍팍해드립니다.", Lineage.robot_auto_buff_aden));
	...
	public void toDamage(Character cha, int dmg, int type, Object...opt){
		...
		ChattingController.toChatting(this, "어서와요. 고객님~", Lineage.CHATTING_MODE_NORMAL);		
