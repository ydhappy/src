...
public class LocationController {
	...
	/**
	 * 귀환 가능한 맵인지 확인해주는 함수. 축순 및 이반도 확인함.
	 * 
	 * @param o
	 * @param packet
	 * @return
	...
	static public boolean isTeleportZone(object o, boolean packet, boolean ment) {
		...
		// 오만1층~10층 일경우 지배부적 확인해서 랜덤텔레포트 가능여부 체크.
			switch (o.getMap()) {
			case 70:
				if (o.getInventory().findDbNameId(26936) != null)
					return true;
				break;
			case 72:
				if (o.getInventory().findDbNameId(26936) != null)
			...
			case 74:
				...
				break;
			case 101:
				if (o.getInventory().findDbNameId(12337) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 102:
				if (o.getInventory().findDbNameId(12338) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 103:
				if (o.getInventory().findDbNameId(12339) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 104:
				if (o.getInventory().findDbNameId(12340) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 105:
				if (o.getInventory().findDbNameId(12341) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 106:
				if (o.getInventory().findDbNameId(12342) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 107:
				if (o.getInventory().findDbNameId(12343) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 108:
				if (o.getInventory().findDbNameId(12344) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 109:
				if (o.getInventory().findDbNameId(12345) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;
			case 110:
				if (o.getInventory().findDbNameId(12346) != null || o.getInventory().findDbNameId(14120) != null)
					return true;
				break;		
			case 780:
				if (o.getInventory().findDbNameId(26936) != null)
	 ...
	 * 지옥 좌표설정.
	 */
	static public void toHell(object o) {
		o.setHomeMap(666);
	...
	static public void toBattlefield(object o) {
		o.setHomeMap(5001);
		o.setHomeX(32791);
		o.setHomeY(32800);
	}
