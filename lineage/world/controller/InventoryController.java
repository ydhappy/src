...
//		lineage.share.System.println("append : "+pool.size());
	...
	/**
	 * 아이템이 악세서리인지 확인하는 메서드.
	 * @param item
	 * @return
	 */
	static public boolean isAccessory(ItemInstance item) {
		return item!=null && isAccessory(item.getItem());
	}
	static public boolean isAccessory(Item item) {
		return 	item.getType2().equalsIgnoreCase("necklace") || 
