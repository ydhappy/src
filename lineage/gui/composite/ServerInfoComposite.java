...
public class ServerInfoComposite extends Composite {
	...
	private Label armor4;
	private Label armor5;
	private Label armor6;
	private Label armor7;
	private Label armor8;
	private Label armor9;
	private Label weapon6;
	private Label weapon7;
	private Label weapon8;
	private Label weapon9;
	private Label weapon10;
	private Label weapon11;
	private long enchant_log_time;
	...
	public ServerInfoComposite(Composite parent, int style) {
		...
		lblObjectId.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblPoolStatus.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblWorld.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblPlayercount.setToolTipText("플레이중인 사용자의 갯수 입니다.");
		...
		lblEtcobjid.setToolTipText("기타객체에 사용하는 고유값.\r\n99999 가 최대치.");
		...
		lblTempetcobjid.setToolTipText("npc, monster 가 사용하는 고유값.\r\n999999 가 최대치.");
		lblTempetcobjid.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblTempetcobjid.setText("npc_objid : ");
		
		npc_objid = new Label(grpServer, SWT.NONE);
		npc_objid.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		npc_objid.setText("100000");
		new Label(grpServer, SWT.NONE);
		new Label(grpServer, SWT.NONE);
		new Label(grpServer, SWT.NONE);
		new Label(grpServer, SWT.NONE);
		...
		lblDatabase.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblPool.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblNewLabel.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		...
		lblNewLabel_2.setFont(SWTResourceManager.getFont("微?雅黑", 9, SWT.BOLD));
		lblNewLabel_2.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 5, 1));
		lblNewLabel_2.setText("- 인첸트별 아이템 갯수 -");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		lblNewLabel_5.setText("+4 : ");
		
		armor4 = new Label(composite_2, SWT.NONE);
		armor4.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor4.setText("0");
		...
		weapon6 = new Label(composite_2, SWT.NONE);
		weapon6.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon6.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		armor5 = new Label(composite_2, SWT.NONE);
		armor5.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor5.setText("0");
		...
		weapon7 = new Label(composite_2, SWT.NONE);
		weapon7.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon7.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		armor6 = new Label(composite_2, SWT.NONE);
		armor6.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor6.setText("0");
		...
		weapon8 = new Label(composite_2, SWT.NONE);
		weapon8.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon8.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		armor7 = new Label(composite_2, SWT.NONE);
		armor7.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor7.setText("0");
		...
		weapon9 = new Label(composite_2, SWT.NONE);
		weapon9.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon9.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		armor8 = new Label(composite_2, SWT.NONE);
		armor8.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor8.setText("0");
		...
		weapon10 = new Label(composite_2, SWT.NONE);
		weapon10.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon10.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		...
		armor9 = new Label(composite_2, SWT.NONE);
		armor9.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));
		armor9.setText("0");
		...
		weapon11 = new Label(composite_2, SWT.NONE);
		weapon11.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		weapon11.setText("0");
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
		new Label(composite_2, SWT.NONE);
	...
	public void toUpdate(){
		...
		npc_objid.setText( String.valueOf(ServerDatabase.getNpc_objid()) );
		...
		ai_thread.setText( String.format("%d-%d-%d", AiThread.getListSize(), AiThread.getRunSize(), AiThread.getPoolSize()) );
		...
		// enchant log
		if(enchant_log_time==0 || enchant_log_time<=System.currentTimeMillis()) {
			enchant_log_time = System.currentTimeMillis() + (1000*60);
			armor4.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(4, false)) );
			armor5.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(5, false)) );
			armor6.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(6, false)) );
			armor7.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(7, false)) );
			armor8.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(8, false)) );
			armor9.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(9, false)) );
			weapon6.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(6, true)) );
			weapon7.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(7, true)) );
			weapon8.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(8, true)) );
			weapon9.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(9, true)) );
			weapon10.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(10, true)) );
			weapon11.setText( String.valueOf(CharactersDatabase.getInventoryEnchantCount(11, true)) );
		}
	}
