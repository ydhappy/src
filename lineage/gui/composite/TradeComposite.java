...
public class TradeComposite extends Composite {
	
	private StyledText chatting;
	private org.eclipse.swt.graphics.Color color_trade_a = SWTResourceManager.getColor(243, 247, 0);
	private org.eclipse.swt.graphics.Color color_trade_b= SWTResourceManager.getColor(255, 0, 0);
	 ...
	 * @param style
	 */
	public TradeComposite(Composite parent, int style) {
		super(parent, style);
	...
	public void toLog(String msg){
		...
		// 색상 입히기.
		if (msg.contains("신청"))
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_trade_a, SWT.BOLD) );
		else
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_trade_b, SWT.BOLD) );
