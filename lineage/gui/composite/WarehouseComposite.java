...
public class WarehouseComposite extends Composite {
	...
	private org.eclipse.swt.graphics.Color color_send = SWTResourceManager.getColor(243, 247, 0);
	private org.eclipse.swt.graphics.Color color_find = SWTResourceManager.getColor(255, 0, 0);
	...
	public void toLog(String msg){
		...
		// 색상 입히기.
		if (msg.contains("찾기"))
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_find, SWT.BOLD) );
		else
			chatting.setStyleRange( getHighlightStyle(log_now_pos, msg.length(), color_send, SWT.BOLD) );
