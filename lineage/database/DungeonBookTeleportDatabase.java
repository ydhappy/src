...
public class DungeonBookTeleportDatabase {
	...
	static public void init(Connection con) {
		TimeLine.start("DungeonBookTeleport..");

		list = new ArrayList<DungeonBook>();
		PreparedStatement st = null;
		ResultSet rs = null;
		try {
			st = con.prepareStatement("SELECT * FROM dungeon_book_teleport");
			rs = st.executeQuery();
			...
			lineage.share.System.printf("%s : init(Connection con)\r\n", DungeonBookTeleportDatabase.class.toString());
	...
	static public void reload() {
		TimeLine.start("dungeon_book_teleport 테이블 리로드 - ");
