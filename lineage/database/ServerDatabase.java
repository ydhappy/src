...
public final class ServerDatabase {
	...
	static private long npc_objid;				// npc, monster, background...
	static private long temp_etc_objid;			// 몬스터나 배경이미지등이 스폰을 다 마치고 마지막 값을 임시 저장함.
	static private long etc_objid;				// 기타 obj값
...
/*	static public long nextEtcObjId() {
	...
	*/
	...
	static public void nextTime(){
		//
		LineageWorldTime += 6;
		LineageWorlddDate.setTime( (LineageWorldTime*1000)+(1000*60*60*15) );  //+(1000*60*60*2)
		//
