...
public class OmanBookTeleportDatabase {
	...
	static public void init(Connection con) {
		TimeLine.start("OmanBookTeleport..");

		list = new ArrayList<DungeonBook>();
		PreparedStatement st = null;
		ResultSet rs = null;
		try {
			st = con.prepareStatement("SELECT * FROM Oman_book_teleport");
			rs = st.executeQuery();
			...
			lineage.share.System.printf("%s : init(Connection con)\r\n", OmanBookTeleportDatabase.class.toString());
	...
	static public void reload() {
		TimeLine.start("Oman_book_teleport 테이블 리로드 - ");
